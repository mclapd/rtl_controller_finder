...
class _ScanResultTileState extends State<ScanResultTile> {
  ...
  Widget build(BuildContext context) {
    ...
    // print("ADV:${adv}");
    var targetUuid = '4880c12c-fdcb-4077-8920-a450d7f9b907';
    // print("Target UUID: $targetUuid");
    // print("Service UUIDs: ${adv.serviceUuids}");
    // adv.serviceUuids.forEach((uuid) {
    //   print("$uuid == $targetUuid ? ${uuid.toString().toLowerCase() == targetUuid.toLowerCase()}");
    // });
    ...
    if (adv.serviceUuids.any(
      ...
      // print("NO ADV:${adv.serviceUuids}");
      return const SizedBox(); // 혹은 다른 위젯을 반환할 수 있음
    }
  }
}
